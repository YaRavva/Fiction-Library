# Банк памяти - Система живой документации

## Что это такое

`Банк памяти` - это набор файлов, в которых хранится долгоживущий контекст проекта: технические ограничения, архитектурные правила, текущее состояние разработки и прогресс.
...
- `Cloud.ru S3`
- `Telegram / GramJS`
- `bun` как пакетный менеджер и среда выполнения
...
Банк памяти должен помогать быстро входить в контекст без догадок. Если код и документация расходятся, приоритет всегда у текущего кода, а документация должна быть обновлена.
