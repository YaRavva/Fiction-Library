...
export function BookCardLargeShadix({
	book,
	onDownload,
	onRead,
	onTagClick,
									...
									? seriesCoverUrls.map((coverUrl, idx) => {
											...
											return (
												<div
													...
													className="relative w-full overflow-hidden rounded border bg-muted transition-transform hover:scale-[1.02] duration-300"
												>
													{wideCover ? (
