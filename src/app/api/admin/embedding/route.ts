...
import { listEmbeddingModels, generateEmbedding, prepareBookText } from "@/lib/embedding-service";
...
export async function PUT(request: NextRequest) {
    try {
        ...
        // Generate embeddings
        const { generateEmbeddings, prepareBookText } = await import("@/lib/embedding-service");
