...
const MotionDialog: React.FC<MotionDialogProps> = ({
	...
	return (
		<MotionDialogContext.Provider
			value={{ animation, show: open || false, isAnimating }}
		>
...
> = (props) => {
	return <DialogPrimitive.Portal data-slot="motion-dialog-portal" {...props} />;
};
...
> = ({ className, ...props }) => {
	return (
		<DialogPrimitive.Description data-slot="motion-dialog-description" asChild>
			<p
