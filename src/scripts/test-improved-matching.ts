...
async function testImprovedMatching() {
  console.log('🚀 Тестируем улучшенную логику сопоставления файлов и книг...\n');
  
  // Тестовые данные, имитирующие проблемный случай
  const testCases = [
    {
      filename: 'Ольга_Голотвина_Великий_Грайан_.zip',
      expectedAuthor: 'Ольга Голотвина',
      expectedTitle: 'Великий Грайан'
    },
    {
      filename: 'Вилма_Кадлечкова_Мицелий.zip',
      expectedAuthor: 'Вилма Кадлечкова',
      expectedTitle: 'Мицелий'
    }
  ];
  ...
  const mockBooks = [
    ...
    { id: '2', title: 'цикл Мицелий', author: 'Вилма Кадлечкова' },
    { id: '3', title: 'цикл Паруса над облаками', author: 'Ольга Голотвина' },
    { id: '4', title: 'цикл Крадуш', author: 'Ольга Болдырева' }
  ];
  
  for (const testCase of testCases) {
    console.log(`\n📁 Тест для файла: ${testCase.filename}`);
  ...
  console.log('\n✅ Тестирование улучшенной логики завершено!');
}
