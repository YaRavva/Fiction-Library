...
async function testBookWormRandomFiles() {
  try {
    console.log('🔍 Тестирование Книжного Червя на случайных файлах...');
    
    const bookWorm = new BookWormService();
    
    // Тестируем режим обновления на небольшом количестве файлов
