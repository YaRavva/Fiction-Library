/**
 * Тестовый скрипт для проверки новой логики обработки файлов
 */
...
async function testNewLogic() {
  console.log('🧪 Тестирование новой логики обработки файлов\n');
    ...
    for (const result of results) {
      ...
      if (result.reason) {
        const reasonText = result.reason === 'book_not_found' ? 'Книга не найдена' : 
                          ...
                          result.reason === 'book_not_imported' ? 'Книга не импортирована' : result.reason;
