...
async function testProblematicCase() {
  console.log('🚀 Тестируем проблемный случай из лога...\n');
  
  // Проблемный случай из лога
  const filename = 'Ольга_Голотвина_Великий_Грайан_.zip';
  
  console.log(`📁 Файл: ${filename}`);
  
  // Извлекаем метаданные (как это делает оригинальный метод)
  ...
  // Имитация найденных книг в базе данных (как в проблемном логе)
  const mockBooks = [
    { id: '1', title: 'цикл Великий Грайан', author: 'Ольга Голотвина' },
    { id: '2', title: 'цикл Паруса над облаками', author: 'Ольга Голотвина' },
    { id: '3', title: 'цикл Крадуш', author: 'Ольга Болдырева' },
    { id: '4', title: 'цикл Пособие для Тёмного князя', author: 'Ольга Болдырева' },
    { id: '5', title: 'Скандинавский цикл', author: 'Ольга Григорьева' },
    { id: '6', title: 'цикл Море', author: 'Ольга Онойко' },
    { id: '7', title: 'Славянский цикл', author: 'Ольга Григорьева' }
  ];
  
  console.log(`  📚 Найдено ${mockBooks.length} потенциальных совпадений по терминам`);
  
  // Проверяем совпадение с тестовыми книгами
  console.log(`  📚 Проверяем совпадение с ${mockBooks.length} тестовыми книгами...`);
  
  // Имитируем ранжирование совпадений
  ...
  console.log('\n✅ Тестирование проблемного случая завершено!');
}
