...
/**
 * Скрипт для пошаговой миграции файлов из Supabase Storage в Cloud.ru S3
 * Обрабатывает файлы один за другим для большей надежности
 * Также сохраняет локальные копии файлов
 */

async function migrateToCloudRu() {
  console.log('🚀 Начинаем пошаговую миграцию файлов из Supabase Storage в Cloud.ru S3');
