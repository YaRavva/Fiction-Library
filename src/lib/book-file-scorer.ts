...
export function scoreFileToBook(
	...
	const fileMatchRatio =
		fileTitleWords.length > 0 ? matchedCount / fileTitleWords.length : 0;
	const bookMatchRatio =
		bookTitleWords.length > 0 ? matchedCount / bookTitleWords.length : 0;
