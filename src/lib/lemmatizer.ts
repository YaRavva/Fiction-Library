...
const NOUN_ENDINGS = [
  'а', 'я', 'ы', 'ий', 'ия', 'ие', 'ий', 'ь', 'у', 'ю', 'е', 'о', 'и', 'ы', 'ам', 'ям', 'ов', 'ев', 'ей', 'ей', 'ем', 'ом', 'ах', 'ях', 'ами', 'ями'
];

const VERB_ENDINGS = [
  'ть', 'ешь', 'ет', 'ем', 'ете', 'ют', 'л', 'ла', 'ло', 'ли', 'ешься', 'ется', 'емся', 'етесь', 'ются', 'юсь', 'ется', 'емся', 'етесь', 'ются'
];

const ADJECTIVE_ENDINGS = [
  'ый', 'ий', 'ой', 'ая', 'яя', 'ое', 'ее', 'ые', 'ие', 'ых', 'их', 'ыми', 'ими', 'ому', 'ему', 'ем', 'им'
];

const PRONOUN_ENDINGS = [
  'я', 'ты', 'он', 'она', 'оно', 'мы', 'вы', 'они', 'мой', 'твой', 'свой', 'его', 'ее', 'их', 'него', 'нее', 'них'
];
