...
### Среда выполнения и язык

- `bun@1.3.1` - пакетный менеджер и среда выполнения проекта;
...
- `react@^19.2.3`
- `react-dom@^19.2.3`
- Структура App Router в `src/app`
...
- форматирование и проверка кода выполняются через `Biome`
...
- развертывание Next.js-приложения на совместимой платформе с поддержкой переменных окружения и серверных маршрутов.
...
- секреты для cron / автоматизации GitHub при использовании автообновления.
