...
**Дата последнего обновления**: 2026-07-07 15:05

## Текущий Фокус

**Дедупликация книг после sync update исправлена**: найден баг, из-за которого метаданные создавали новые книги вместо обновления существующих, и добавлена защита ручной привязки от повторного использования одного Telegram-файла.
