...
**Исправление ошибки Select.Item**: Устранена ошибка в компоненте расширенного поиска, связанная с пустыми значениями в Radix UI Select компонентах.

## Активные Задачи

### Фаза 5: Исправление ошибок UI (Текущая)
...
- ✅ **minRating Select**: Заменено `value=""` на `value="any"`
- ✅ **maxRating Select**: Заменено `value=""` на `value="any"`  
- ✅ **hasFile Select**: Заменено `value=""` на `value="any"`
- ✅ **Логика обработки**: Обновлена для корректной работы с новыми значениями
