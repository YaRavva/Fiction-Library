...
function syncMissingDescriptions() {
    return __awaiter(this, arguments, void 0, function (limit) {
        var supabase, _a, booksWithoutDescriptions, fetchError, _b, allBooksWithoutDescriptions, allFetchError, syncService, processed, updated, skipped, errors, _i, booksWithoutDescriptions_1, book, typedBook, channel, channelId, messages, msg, anyMsg, metadata, updateData, updateError, error_1, typedBook, error_2;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .limit(limit)];
                case 1:
                    _a = _c.sent(), booksWithoutDescriptions = _a.data, fetchError = _a.error;
                    if (fetchError) {
                        throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u044F \u043A\u043D\u0438\u0433 \u0431\u0435\u0437 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0439: ".concat(fetchError.message));
                    }
                    if (!(!booksWithoutDescriptions || booksWithoutDescriptions.length === 0)) return [3 /*break*/, 3];
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .limit(limit)];
                case 2:
                    _b = _c.sent(), allBooksWithoutDescriptions = _b.data, allFetchError = _b.error;
                    if (allFetchError) {
                        throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u044F \u0432\u0441\u0435\u0445 \u043A\u043D\u0438\u0433 \u0431\u0435\u0437 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0439: ".concat(allFetchError.message));
                    }
                ...
                case 4:
                    ...
                    _c.label = 5;
                case 5:
                    if (!(_i < booksWithoutDescriptions_1.length)) return [3 /*break*/, 12];
