...
function debugMessage(messageId) {
    return __awaiter(this, void 0, void 0, function () {
        var syncService, channel, channelId, messages, msg, anyMsg, metadata, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("\uD83D\uDCE5 \u041F\u043E\u043B\u0443\u0447\u0430\u0435\u043C \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 ".concat(messageId, " \u0438\u0437 Telegram..."));
                ...
                case 2:
                    ...
                    channelId = typeof channel.id === 'object' && channel.id !== null ?
                        channel.id.toString() :
                        String(channel.id);
                    return [4 /*yield*/, syncService.telegramClient.getMessages(channelId, 1, messageId)];
                case 3:
                    messages = _a.sent();
                    ...
                    console.log("ID: ".concat(anyMsg.id));
                    ...
                    console.log("\uD83D\uDCC4 \u041F\u0430\u0440\u0441\u0438\u043D\u0433 \u0442\u0435\u043A\u0441\u0442\u0430 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u044F...");
