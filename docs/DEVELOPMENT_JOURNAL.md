...
- 🔧 Обновлен парсер для поддержки `MessageMediaWebPage`
- 🔧 Улучшен метод `downloadMedia` в клиенте Telegram
...
- 🔧 Настройка Next.js для поддержки Supabase Storage
...
**Решение:**
- 🔧 Добавлена миграция для полей `series_composition` и `cover_urls`
- 🔧 Обновлен парсер для сбора всех сообщений альбома
...
- 🔧 Создана миграция с функциями поиска дубликатов
- 🔧 Добавлены триггеры для автоматической проверки при вставке
- 🔧 Создан скрипт для поиска и автоматического объединения дубликатов
...
#### 11 октября 2025 - Создание документации по переходу на Yandex Cloud
...
6. **Создание документации по переходу на Yandex Cloud**
...
6. **Документация по переходу на Yandex Cloud**
   - Подробная инструкция по миграции
...
6. **Поиск файлов**
   ...
   - Оптимизировать интерфейс для отображения большого количества файлов
